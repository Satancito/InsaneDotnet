...
namespace InsaneIO.Insane.Tests
{
    ...
    public class RsaExtensionsUnitTests
    {
        ...
        [TestMethod]
        public void CreateRsaKeyPair_ShouldCreateBerEncodedKeys()
        {
            CreateKeyPair(KeySize, RsaKeyPairEncoding.Ber);
        }

        [TestMethod]
        public void CreateRsaKeyPair_ShouldCreatePemEncodedKeys()
        {
        ...
        public void ValidateRsaPublicKey_ShouldRejectNullValue()
        {
        ...
        [TestMethod]
        //[ExpectedException(typeof(ArgumentException))]
        public void ValidateRsaPrivateKey_ShouldRejectNullValue()
        {
        ...
        [TestMethod]
        public void ValidateRsaKeys_ShouldSupportBerEncoding()
        {
        ...
        [TestMethod]
        public void ValidateRsaKeys_ShouldSupportPemEncoding()
        {
        ...
        [TestMethod]
        public void ValidateRsaKeys_ShouldSupportIndentedXmlEncoding()
        {
            ValidateRsaKey(PublicKeyXml, PrivateKeyXml);
        }

        public void EncryptDecryptRsa_ShouldRoundTrip(string data, string publicKey, string privateKey, IEncoder encoder)
        {
            var encrypted = data.EncryptRsaEncoded(publicKey, encoder);
            string decrypted = encrypted.DecryptRsaFromEncoded(privateKey, encoder).ToStringUtf8();
            Console.WriteLine($"PublicKey: {Environment.NewLine}{publicKey}");
            Console.WriteLine($"PrivateKey: {Environment.NewLine}{privateKey}");
            Console.WriteLine();
        ...
        [TestMethod]
        public void EncryptDecryptRsa_ShouldSupportBerKeysWithBase64Encoder()
        {
            EncryptDecryptRsa_ShouldRoundTrip(Data, PublicKeyBer, PrivateKeyBer, Base64Encoder.DefaultInstance);
        }

        [TestMethod]
        public void EncryptDecryptRsa_ShouldSupportPemKeysWithBase64Encoder()
        {
            EncryptDecryptRsa_ShouldRoundTrip(Data, PublicKeyPem, PrivateKeyPem, Base64Encoder.DefaultInstance);
        }

        [TestMethod]
        public void EncryptDecryptRsa_ShouldSupportIndentedXmlKeysWithBase64Encoder()
        {
            EncryptDecryptRsa_ShouldRoundTrip(Data, PublicKeyXml, PrivateKeyXml, Base64Encoder.DefaultInstance);
        }


        [TestMethod]
        public void GetRsaKeyEncoding_ShouldDetectExpectedEncoding()
        {
            ...
            var encrypted = Data.EncryptRsaEncoded(publicKey, Base64Encoder.DefaultInstance);
            Assert.AreEqual(Data, encrypted.DecryptRsaFromEncoded(privateKey, Base64Encoder.DefaultInstance).ToStringUtf8());
        }
    }
}
